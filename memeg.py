...
async def help(event):
  helptext = "**Halo 👋🏻!\n\nKenalin Nih, Gua Bot Tag All Yang Di Rancang Sama @ANGELINEAYI Dengan Berbasis Python.\n\nGua Siap Membantu Lu Dengan Mention Semua Anggota Di Group Lu Dengan Cara /all & /cancel**"
  await event.reply(
    helptext,
    link_preview=False,
    buttons=(
      [
        Button.url('Developer', 't.me/ANGELINEAYI'),
      ],
      [
